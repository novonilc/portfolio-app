...
const STOCKS = [
  ...
  { ticker:'NVDA',  name:'Nvidia',                    sector:'Technology',             market:'US', mktCap:'mega',  isBank:false, pe:45,  fwdPe:35, epsGrowth:80, roe:80,  de:0.4, divYield:0.0, fcfYield:2.0, grossMargin:75, peg:0.56, price:1100, moat:'AI Chip Monopoly' },
